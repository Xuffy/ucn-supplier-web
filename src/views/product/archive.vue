    ...
    <div class="footer">
      <v-table
        ...
        <template slot="header">
          <div class="btns">
            <el-button
              v-authorize="'PRODUCT:ARCHIVE:RECOVER'" :disabled="disabledDeleteGoods"
              @click="recover">{{$i.common.recover}}</el-button>
            <el-button @click="download" v-authorize="'PRODUCT:ARCHIVE:DOWNLOAD'">
