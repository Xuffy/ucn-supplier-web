<template>
    <div class="Details" v-loading="loadingTable">
                ...
                <el-row>
                    ...
                    <el-col :span="18">
                        <el-form :modal="productForm" ref="sourcingDetail" label-width="190px">
                            <el-row>
                                <el-col v-for="v in $db.product.detailTop" :key="v.key" class="list" :xs="24"
            ...
            <el-tabs v-model="tabName" type="border-card">
                ...
                <el-tab-pane :label="$i.product.customersInfo" name="Customer Info">
                    <el-form class="speForm" label-width="290px" :label-position="labelPosition">
                        <el-row>
                            <el-col v-if="v.belongTab==='customerInfo'" v-for="v in $db.product.detailNewTab"
                                    :key="v.key" class="list" :xs="24" :sm="24" :md="v.fullLine?24:12"
                                    :lg="v.fullLine?24:12" :xl="v.fullLine?24:12">
                                <el-form-item :label="v.label+':'">
                                    {{productForm[v.key]}}
                                </el-form-item>
                            </el-col>
                ...
                <el-tab-pane :label="$i.product.packingInfo" name="Packing Info">
                    <el-form class="speForm" label-width="300px" :label-position="labelPosition">
                        <el-row>
                            <el-col v-if="v.belongTab==='packingInfo'" v-for="v in $db.product.detailNewTab"
                                    :key="v.key" class="list" :xs="24" :sm="24" :md="v.fullLine?24:12"
                                    :lg="v.fullLine?24:12" :xl="v.fullLine?24:12">
                                <el-form-item :label="v.label+':'">
                                    {{productForm[v.key]}}
        ...
        <v-import-template ref="importCategory" code="BIZ_SKU_SUPPLIER_IMPORT" biz-code="BIZ_SKU_SUPPLIER_IMPORT"
                           :tips="$i.product.uploadTips"></v-import-template>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            setUpDown() {
                ...
                this.$confirm(info, this.$i.product.prompt, {
            ...
            download() {
                this.$fetch.export_task("SKU_SUPPLIER_EXPORT_IDS", { ids: [this.productForm.id] });
            },
            deleteProduct() {
